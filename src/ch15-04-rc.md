...
<span class="caption">圖示 15-3: Two lists, `b` and `c`, sharing ownership of
a third list, `a`</span>
...
<span class="caption">範例 15-17: Demonstrating we’re not allowed to have
...
<span class="caption">範例 15-18: A definition of `List` that uses
`Rc<T>`</span>
...
<span class="caption">範例 15-19: Printing the reference count</span>
